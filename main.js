...
const dogsAreTheBest = true
    // alert(dogsAreTheBest)

const tigersHaveClaws = true
    // alert(tigersHaveClaws)

let catsAreGreat = false
    // alert(catsAreGreat)
...
//  Remember: "return will call the num but it will not show"

function sumThreeAndDivideFourth(n1, n2, n3, n4) {
    return (n1 + n2 + n3) / n4
}
// console.log(sumThreeAndDivideFourth(2, 6, 4, 3))


// Create a function that takes in 2 numbers. Console log the first number to the power of the second. Call the function.

function moPow(oneCat, oneDog) {
    console.log( Math.pow(oneCat, oneDog))
}
// moPow(4,2)
